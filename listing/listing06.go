...
Увеличение емкости происходит по формуле:
   ...
   < 2048    =>    cap*1.35
   < 4096    =>    cap*1.3
В данном случае i[0] = "3"значения в обоих слайдах ссылаются на один базовый массив.
	Но после первого выполнения функции appendпроизойдет выделение нового массива,
		и после этого слайды sи iбудут отображаться на разных массивах.
			Поэтому следующее изменение i[1]="5"не разразится на слайде s.
*/
